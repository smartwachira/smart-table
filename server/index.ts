...
// ⚡ IMPORT OUR NEW SOCKET HANDLER
import { initializeSockets } from './utils/socketHandler.js';
...
// ⚡ Delegate all socket connection and auth logic to our dedicated handler
...
// ==========================================
Venue.hasMany(MenuCategory,{ foreignKey: 'venue_id', sourceKey: 'venue_id', onDelete: 'CASCADE' });
MenuCategory.belongsTo(Venue,{ foreignKey: 'venue_id', targetKey: 'venue_id' });

MenuCategory.hasMany(MenuItem,{ foreignKey: 'category_id', sourceKey: 'category_id', onDelete: 'CASCADE' });
MenuItem.belongsTo(MenuCategory, { foreignKey: 'category_id', targetKey: 'category_id' });
...
Venue.hasMany(User, { foreignKey: 'venue_id', sourceKey: 'venue_id', onDelete: 'CASCADE', as: 'staff' });
User.belongsTo(Venue, { foreignKey: "venue_id", targetKey: 'venue_id', as: 'venue' });

User.hasMany(Order, { foreignKey: 'cash_collected_by', sourceKey: 'user_id', as: 'CollectedOrders' });
Order.belongsTo(User, { foreignKey: 'cash_collected_by', targetKey: 'user_id', as: 'CashCollector' });
